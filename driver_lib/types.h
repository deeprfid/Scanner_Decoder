...
/* bsd */
typedef uint8t			u_char;		/**< 8-bit value */
typedef uint8t 			SOCKET;
typedef uint16t			u_short;	/**< 16-bit value */
typedef uint16t			u_int;		/**< 16-bit value */
typedef uint32t			u_long;		/**< 32-bit value */
